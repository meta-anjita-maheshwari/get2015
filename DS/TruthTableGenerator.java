...
public class TruthTableGenerator {
	...
	/**
	 * generates truth table if expression is valid.
	 * @param input
	 */
	...
	/**
	 * furnishes the string: cancel out two consecutive '~'.
	 * @param input
	 * @return: furnished string
	 */
	...
	/**
	 * Perform And(&) an d Or(|) operation
	 * @param c1
	 * @param c2
	 * @param op
	 * @return : T(True) or F(false) result
	 */
	...
	/**
	 * Stores all possible binary combination of unique variables.  
	 * @param numberOfCharacters
	 * @return : 2^n binary combinations.
	 */
