...
public class TrainManagement {
	...
	List<Train> gTrainList=new ArrayList<Train>();
	...
	public static void main(String[] args) {
		...
		// Write in train file
		try {
			trainM.writeData("C://Users//Anjita//workspace//OOPsSession3//src//Assignments//Train.csv");
			trainM.readData("C://Users//Anjita//workspace//OOPsSession3//src//Assignments//Train.csv");
			//trainM.printPTrain();
		} catch (IOException e) {
			e.printStackTrace();
		}
